...
class ClienteServiceTest {
  ...
  @BeforeAll
  static void inicializaClienteService() {
  ...
  class ListaClientesTest {
    @BeforeEach
    void mockClienteRepositoryFindAll() {
  ...
  class TransformarDTOTest {
    ...
    void transformClienteDTOIntoCliente() {
  ...
  class RetornaClienteByIdTest {
    ...
    void returnClienteWhenClienteExist() {
    ...
    void returnClienteWhenClienteDoesNotExist() {
  ...
  class AtualizaClienteTest {
    @BeforeEach
    void mockClienteRepositoryFindById() {
  ...
  class ApagaClienteTest {
    ...
    void throwExceptionWhenCouldNotDeleteCliente() {
  ...
  class RetornaPedidosClienteTest {
    ...
    void returnPedidosOfTheCliente() {
      when(clienteRepository.findById(anyLong())).thenReturn(java.util.Optional.of(cliente1));
